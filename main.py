...
class Motor(Controller):
    ...
    def setTargetSpeed(self, value):
        self.controller.setRegister(0x60ff, value, 4, node=self.node)
...
C.printStatus()
print("Set Speed")
X1.setTargetSpeed(4000)
print("Speed Set Complete")
print("")
